    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          {/* Problem */}
          {activeState === "problemList" && (
            <ProblemList onNavigate={handleNavigation} />
          )}
          {activeState === "problemCreate" && (
            <ProblemCreator onNavigate={handleNavigation} />
          )}
          {activeState === "problemEdit" && (
            <ProblemEdit
              onNavigate={handleNavigation}
              setCurrentTitleProblem={setCurrentTitleProblem}
            />
          )}

          {/* Exam */}
          {activeState === "examList" && (
            <ExamList onNavigate={handleNavigation} />
          )}
          {activeState === "examCreate" && (
            <CreateExam onNavigate={handleNavigation} />
          )}
          {activeState === "examResult" && (
            <ExamResult onNavigate={handleNavigation} />
          )}
          {activeState === "examEdit" && (
            <EditExam onNavigate={handleNavigation} />
          )}

          {/* User */}
          {activeState === "userList" && (
            <UserList onNavigate={handleNavigation} />
          )}
          {activeState === "userCreate" && (
            <CreateUser onNavigate={handleNavigation} />
          )}
          {activeState === "userEdit" && (
            <EditUser onNavigate={handleNavigation} />
          )}
          {activeState === "tagList" && (
            <TagList onNavigate={handleNavigation} />
          )}

          {/* Course */}
          {activeState === "courseList" && (
            <CourseList onNavigate={handleNavigation} />
          )}
          {activeState === "createCourse" && (
            <CreateCourse onNavigate={handleNavigation} />
          )}
          {activeState === "updateCourse" && (
            <UpdateCourse
              onNavigate={handleNavigation}
              setCurrentTitleCourse={setCurrentTitleCourse}
            />
          )}
          {activeState === "chapterList" && (
            <ChapterList onNavigate={handleNavigation} />
          )}
          {activeState === "createChapter" && (
            <CreateChapter onNavigate={handleNavigation} />
          )}
          {activeState === "updateChapter" && (
            <UpdateChapter
              onNavigate={handleNavigation}
              setCurrentTitleChapter={setCurrentTitleChapter}
            />
          )}
          {activeState === "lessonList" && (
            <LessonList onNavigate={handleNavigation} />
          )}
          {activeState === "createLesson" && (
            <CreateLesson onNavigate={handleNavigation} />
          )}
          {activeState === "updateLesson" && (
            <UpdateLesson
              onNavigate={handleNavigation}
              setCurrentTitleLesson={setCurrentTitleLesson}
            />
          )}
        </div>
      </SidebarInset>
