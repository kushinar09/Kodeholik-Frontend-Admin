    ...
    return (
        <div className="space-y-4">
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            {user.status !== "BANNED" &&
                                                ...
                                                >
                                                    <svg class="h-8 w-8 text-red-500" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <rect x="5" y="11" width="14" height="10" rx="2" />  <circle cx="12" cy="16" r="1" />  <path d="M8 11v-4a4 4 0 0 1 8 0v4" /></svg>
                                                    Ban
                                                </DropdownMenuItem>
                                            }
                                            ...
                                            {user.status === "BANNED" &&
                                                ...
                                                >
                                                    <svg class="h-8 w-8 text-green-500" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <rect x="5" y="11" width="14" height="10" rx="2" />  <circle cx="12" cy="16" r="1" />  <path d="M8 11v-5a4 4 0 0 1 8 0" /></svg>
                                                    Unban
                                                </DropdownMenuItem>
                                            }
                                        </DropdownMenuContent>
            ...
            <div className="flex justify-between items-center mt-4 w-full">
                {
                    !isLoading && totalPages > 1 && !noContent && (<div className="flex-1 flex justify-center gap-2">
                        <Button
                            variant="ghost"
