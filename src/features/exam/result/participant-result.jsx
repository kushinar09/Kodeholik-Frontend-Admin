      ...
      {!isLoading &&
        <div className="space-y-6">
          ...
          <Card style={{ marginTop: '10px' }}>
              ...
              <CardTitle>
                <div className="flex items-center">
                  ...
                  {currentProblem.percentPassed == '100%'
                    ? <div className="flex items-center">
                      <svg class="ml-4 h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="ml-1 text-green-600">{currentProblem.point} points</span>
                    </div>
                    : <div className="flex items-center">
                      <svg class="ml-4 h-5 w-5 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {currentProblem != null && submitted != null && <CardContent className="space-y-4">
              <div className="flex justify-between flex-wrap gap-4">
